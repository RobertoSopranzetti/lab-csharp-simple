...
namespace ComplexAlgebra
{
    ...
    public class Complex
    {
        ...
        public Complex Sum(Complex other) => new Complex(Real + other.Real, Imaginary + other.Imaginary);

        public Complex Sub(Complex other) => new Complex(Real - other.Real, Imaginary - other.Imaginary);
